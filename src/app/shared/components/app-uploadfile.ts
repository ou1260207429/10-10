...
import { createguid } from '@shared/utils/regular-expression';
import { AppId } from '@shared/utils/expression';
...
export class UploadFileComponent {
    ...
    customReq = (item: UploadXHRArgs) => {
        ...
        header.set('Authorization', 'Bearer ' + this.appSession.getAccessToken());
        const params = {
            sourceId: createguid(),
            AppId,
            module: "table",
