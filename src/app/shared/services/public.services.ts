...
export class PublicServices {
    ...
    newUpload(files: any, params): Observable<any> {
        const url = "api/Upload/Upload?" + "AppId=" + params.AppId + "&module=" + params.module + "&sourceId=" + params.sourceId;
    ...
    getFilesDetail(page: any): Observable<any> {
        const url = "api/Attachment/AttachmentListBySourceId?" + "appId=" + page.AppId + "&module=" + page.module + "&sourceId=" + page.sourceId
    ...
    delete(page: any): Observable<any> {
        const url = "api/Attachment/Delete?" + "appId=" + page.AppId + "&id=" + page.id
        return this.http.post(URLConfig.getInstance().REGISTER_URL + url, page);
    }
